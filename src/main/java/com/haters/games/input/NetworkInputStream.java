...
public class NetworkInputStream implements GameInputStream {
    ...
    private final Map<Integer, Object[]> inputStateByPlayers = new HashMap<Integer, Object[]>();
    private final List<Integer> newPlayers = new ArrayList<Integer>();
    private final List<Integer> removePlayers = new ArrayList<Integer>();
    private final List<Object[]> bebornPlayers = new ArrayList<Object[]>();
