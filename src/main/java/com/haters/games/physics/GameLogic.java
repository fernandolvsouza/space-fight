...
public class GameLogic {
    ...
    private final SpaceWorld spaceWorld;
    private final List<Group> groups = new ArrayList<Group>(numberOfGroups);

    private final List<SpaceShip> players = new ArrayList<SpaceShip>(1000);
    private final List<Star> stars = new ArrayList<Star>(numberOfStars);
    private final List<Base> bases = new ArrayList<Base>(numberOfBases);
    private final GameInputStream istream;
    private final NetworkOutputStream ostream;

    private final long[] rankingIds = new long[ranksize];
